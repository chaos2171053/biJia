 ...
 */
public class AllProductsActivity extends ListActivity {// Progress Dialog
    ...
    private static String url_all_products = "http://163.17.21.33/android_connect/get_all_products.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                {
                    setNetworkMethod(AllProductsActivity.this);
                }
                else {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    if(productsList.size()==0){
                        Toast.makeText(AllProductsActivity.this, "没有购买记录", Toast.LENGTH_SHORT).show();
                    }
                }
            });
