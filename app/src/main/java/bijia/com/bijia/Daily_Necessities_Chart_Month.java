 ...
 */
public class Daily_Necessities_Chart_Month extends ListActivity {
    ...
    private static String url_dail_nec_chart_month = "http://163.17.21.33/android_connect/history_month_goods_class.php";
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (is3g == false && isWifi == false) {
                    setNetworkMethod(Daily_Necessities_Chart_Month.this);
                } else {
                    // Starting new intent
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Daily_Necessities_Chart_Month.this);
        ...
        protected String doInBackground(String... args) {
            ...
            String daily_necessities_month="日常用品";
            ...
            params.add(new BasicNameValuePair("chart_month_daily_necessities_categories",daily_necessities_month));
            // getting JSON string from URL
            JSONObject json = jParser.makeHttpRequest(url_dail_nec_chart_month, "GET", params);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            Daily_Necessities_Chart_Month.this, productsList,
                    ...
                    if(productsList.size()==0){
                        Toast.makeText(Daily_Necessities_Chart_Month.this, "没有购买记录", Toast.LENGTH_SHORT).show();
                    }
                }
            });
