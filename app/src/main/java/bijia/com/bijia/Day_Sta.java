 ...
 */
public class Day_Sta extends ListActivity {// Progress Dialog
    ...
    private static String url_day_sta_products = "http://163.17.21.33/android_connect/today_sta.php";
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Day_Sta.this);
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jParser.makeHttpRequest(url_day_sta_products, "GET", params);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    if(productsList.size()==0){
                        Toast.makeText(Day_Sta.this, "没有购买记录", Toast.LENGTH_SHORT).show();
                    }
                }
            });
