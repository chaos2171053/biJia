 ...
 */
public class Food_Chart_Day extends ListActivity {// Progress Dialog
    ...
    private static String url_food_chart_day = "http://163.17.21.33/android_connect/history_today_goods_class.php";
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (is3g == false && isWifi == false) {
                    setNetworkMethod(Food_Chart_Day.this);
                } else {
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Food_Chart_Day.this);
        ...
        protected String doInBackground(String... args) {
            ...
            params.add(new BasicNameValuePair("chart_day_food_categories",food_day));
            // getting JSON string from URL
            JSONObject json = jParser.makeHttpRequest(url_food_chart_day, "GET", params);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            Food_Chart_Day.this, productsList,
                    ...
                    if(productsList.size()==0){
                        Toast.makeText(Food_Chart_Day.this, "没有购买记录", Toast.LENGTH_SHORT).show();
                    }
                }
            });
