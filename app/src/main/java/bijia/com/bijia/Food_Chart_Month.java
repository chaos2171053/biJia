 ...
 */
public class Food_Chart_Month extends ListActivity {// Progress Dialog
    ...
    private static String url_food_chart_month = "http://163.17.21.33/android_connect/history_month_goods_class.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                {
                    setNetworkMethod(Food_Chart_Month.this);
                }
                else {
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Food_Chart_Month.this);
        ...
        protected String doInBackground(String... args) {
            ...
            params.add(new BasicNameValuePair("chart_month_food_categories",food_month));
            // getting JSON string from URL
            JSONObject json = jParser.makeHttpRequest(url_food_chart_month, "GET", params);
...
//                    startActivity(i);
        ...
        protected void onPostExecute(String file_url) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            Food_Chart_Month.this, productsList,
            ...
            if(productsList.size()==0){
                Toast.makeText(Food_Chart_Month.this, "没有购买记录", Toast.LENGTH_SHORT).show();
            }
