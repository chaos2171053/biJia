 ...
 */
public class Month_Sta extends ListActivity {// Progress Dialog
    ...
    private static String url_month_sta_products = "http://163.17.21.33/android_connect/month_sta.php";
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (is3g == false && isWifi == false) {
                    setNetworkMethod(Month_Sta.this);
                } else {
                    // Starting new intent
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Month_Sta.this);
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jParser.makeHttpRequest(url_month_sta_products, "GET", params);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    if(productsList.size()==0){
                        Toast.makeText(Month_Sta.this, "没有购买记录", Toast.LENGTH_SHORT).show();
                    }
                }
            });
