 ...
 */
public class Cloth_Chart_Month extends ListActivity {
    ...
    private static String url_cloth_chart_month= "http://163.17.21.33/android_connect/history_month_goods_class.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                {
                    setNetworkMethod(Cloth_Chart_Month.this);
                }
                else {
                    // Starting new intent
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Cloth_Chart_Month.this);
        ...
        protected String doInBackground(String... args) {
            ...
            params.add(new BasicNameValuePair("chart_month_cloth_categories",cloth_month));
            // getting JSON string from URL
            JSONObject json = jParser.makeHttpRequest(url_cloth_chart_month, "GET", params);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            Cloth_Chart_Month.this, productsList,
                    ...
                    if(productsList.size()==0){
                        Toast.makeText(Cloth_Chart_Month.this, "没有购买记录", Toast.LENGTH_SHORT).show();
                    }
                }
            });
