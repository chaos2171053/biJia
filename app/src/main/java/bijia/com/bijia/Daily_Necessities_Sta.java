 ...
 */
public class Daily_Necessities_Sta extends ListActivity {// Progress Dialog
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                {
                    setNetworkMethod(Daily_Necessities_Sta.this);
                }else {
                    // Starting new intent
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Daily_Necessities_Sta.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            Daily_Necessities_Sta.this, productsList,
                    ...
                    if(productsList.size()==0){
                        Toast.makeText(Daily_Necessities_Sta.this, "没有购买记录", Toast.LENGTH_SHORT).show();
                    }
                }
            });
