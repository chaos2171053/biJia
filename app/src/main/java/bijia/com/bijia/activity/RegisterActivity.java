        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if ( !email.isEmpty() && !password.isEmpty()) {
                    ...
                    {
                        setNetworkMethod(RegisterActivity.this);
                    }
...
//                        db.addUser(name, email, uid, created_at);  //新用户注册 旧用户登录

                        Toast.makeText(getApplicationContext(), "注册成功~开始登录~", Toast.LENGTH_LONG).show();
