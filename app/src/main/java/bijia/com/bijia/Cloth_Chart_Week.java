 ...
 */
public class Cloth_Chart_Week extends ListActivity {
    ...
    private static String url_cloth_chart_week = "http://163.17.21.33/android_connect/history_week_goods_class.php";
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (is3g == false && isWifi == false) {
                    setNetworkMethod(Cloth_Chart_Week.this);
                } else {
                    // Starting new intent
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Cloth_Chart_Week.this);
        ...
        protected String doInBackground(String... args) {
            ...
            params.add(new BasicNameValuePair("chart_week_cloth_categories",cloth_week));
            // getting JSON string from URL
            JSONObject json = jParser.makeHttpRequest(url_cloth_chart_week, "GET", params);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            Cloth_Chart_Week.this, productsList,
                    ...
                    if(productsList.size()==0){
                        Toast.makeText(Cloth_Chart_Week.this, "没有购买记录", Toast.LENGTH_SHORT).show();
                    }
                }
            });
