 ...
 */
public class Applicances_Chart_Day extends ListActivity {
    ...
    private static String url_appliances_chart_day = "http://163.17.21.33/android_connect/history_today_goods_class.php";
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (is3g == false && isWifi == false) {
                    setNetworkMethod(Applicances_Chart_Day.this);
                } else {
                    // Starting new intent
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Applicances_Chart_Day.this);
        ...
        protected String doInBackground(String... args) {
            ...
            params.add(new BasicNameValuePair("chart_day_appliances_categories",appliances_day));
            // getting JSON string from URL
            JSONObject json = jParser.makeHttpRequest(url_appliances_chart_day, "GET", params);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            Applicances_Chart_Day.this, productsList,
                    ...
                    if(productsList.size()==0){
                        Toast.makeText(Applicances_Chart_Day.this, "没有购买记录", Toast.LENGTH_SHORT).show();
                    }
                }
            });
