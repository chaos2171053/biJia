 ...
 */
public class Week_PieChart extends Activity {
    private com.github.mikephil.charting.charts.PieChart mChart;
    private static String url_week_categories_piechart = "http://163.17.21.33/android_connect/week_product_class.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.week_categories_pichart);
        getButtonVIEW();
        setButtonEvent();
        ...
        public void onClick(View view) {
            ...
            switch(view.getId()){
                case R.id.food:
                    ...
                    {
                        setNetworkMethod(Week_PieChart.this);
                    }
                    else {
                        Intent intent1 = new Intent();
                        intent1.setClass(Week_PieChart.this, Food_Chart_Week.class);
                ...
                case R.id.cloth:
                    if(is3g == false && isWifi == false )
                    {
                        ...
                        intent2.setClass(Week_PieChart.this, Cloth_Chart_Week.class);
                ...
                case R.id.appliances:
                    if(is3g == false && isWifi == false )
                    {
                        ...
                        intent3.setClass(Week_PieChart.this, Applicances_Chart_Week.class);
                ...
                case R.id.daily_necessities:
                    if(is3g == false && isWifi == false )
                    {
                        ...
                        intent4.setClass(Week_PieChart.this, Daily_Necessities_Chart_Week.class);
...
//        }
        ...
        {
            Toast.makeText(Week_PieChart.this, "没有购买记录", Toast.LENGTH_SHORT).show();
    ...
    class LoadCategoriesPieChart extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Week_PieChart.this);
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jsonParser.makeHttpRequest(url_week_categories_piechart, "GET", params);
