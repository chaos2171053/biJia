 ...
 */
public class Gaoxiong_Sta extends ListActivity {// Progress Dialog
    ...
    private static String url_tw_places_products = "http://163.17.21.33/android_connect/place_sta.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                {
                    setNetworkMethod(Gaoxiong_Sta.this);
                }else {
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Gaoxiong_Sta.this);
        ...
        protected String doInBackground(String... args) {
            ...
            params.add(new BasicNameValuePair("tw_places",tw_place));

            // getting JSON string from URL
            JSONObject json = jParser.makeHttpRequest(url_tw_places_products, "GET", params);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            Gaoxiong_Sta.this, productsList,
                    ...
                    if(productsList.size()==0){
                        Toast.makeText(Gaoxiong_Sta.this, "没有购买记录", Toast.LENGTH_SHORT).show();
                    }
                }
            });
