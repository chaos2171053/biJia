 ...
 */
public class Taizhong_Sta extends ListActivity {// Progress Dialog
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                {
                    setNetworkMethod(Taizhong_Sta.this);
                }else {
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Taizhong_Sta.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            Taizhong_Sta.this, productsList,
                    ...
                    if(productsList.size()==0){
                        Toast.makeText(Taizhong_Sta.this, "没有购买记录", Toast.LENGTH_SHORT).show();
                    }
                }
            });
